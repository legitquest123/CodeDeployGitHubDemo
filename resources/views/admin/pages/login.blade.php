                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.html">
                                        <span><img src="{{asset('public/asset/images/logo-dark.png')}}" alt="" height="22"></span>
                                    </a>
                                ...
                                <form>
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button href="{{URL('dashboard')}}" class="btn btn-primary btn-block" type="submit"> Log In </button>
                                    </div>
