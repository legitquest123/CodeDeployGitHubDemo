...
@section('title','LegitQuest | Services')
@section('content')
  <main class="main">
      ...
      <div class="container">
        <div class="contact__wrapper shadow-lg mt-n9 request-form-wrappper">
          ...
          <div class="row no-gutters">
            <div class="col-lg-5 contact-info__wrapper gradient-brand-color p-4 order-lg-2">
              <h3 class="text-white font-weight-bold mb-4">Legitquest launches "Legal Translation & Typing Services"</h3>
              <p>Legitquest, with it's efficient team of translators and typists, is dedicated to provide you with excellent quality services. Legal Translation is available in various languages, i.e. Hindi, English, Marathi, Bengali, Gujarati, Kannada, Urdu, e.t.c</p>
              <p>For any translation work, contact/wats app on this number - +91-8375005706 or email us at - translation@legitquest.com</p>
              <p>For any typing work, contact/wats app on this number - +91-8375005706 or email us at - typing@legitquest.com</p>
            ...
            <div class="col-lg-7 contact-form__wrapper p-4 order-lg-1">
              <form class="contact-form form-validate" name="serviceform" method="POST" action="{{route('addservices')}}" name="serviceform"> 
              	@csrf
        ...
        <div class="row">
            ...
            <div class="col-sm-6 mb-3">
                ...
                <input class="form-control" name="lastname" id="lastname" type="text" Last name">
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 mb-3">
                ...
                <input class="form-control" name="mobile" id="mobile" maxlength="10" type="text" placeholder="Mobile number">
            </div>
            <div class="col-sm-6 mb-3">
        ...
        <div class="form-group">
          <div class="custom-radio custom-control-inline">
            <label class="f-14 font-weight-normal d-flex">
              <input class="d-none" type="radio" name="type" value="Freelancer" checked="">
              <span class="text-dark">Freelancer</span>
            </label>
          </div>
          <div class="custom-radio custom-control-inline">
            <label class="f-14 font-weight-normal d-flex">
              <input class="d-none" type="radio" value="Full time" name="type">
        ...
        <div class="row">
             <div class="col-sm-12 mb-3">
                ...
                <textarea class="form-control" name="message" id="message" rol="5" cols="30"  placeholder="Leave your message"></textarea>
            </div>
        </div>
          ...
          <div class="col-md-8 col-lg-7 col-xl-6 text-center">
            ...
            <form class="subscribe-form form-inline mt-5" novalidate="true">
              <div class="input-group mr-sm-3 mb-2">
                <input type="email" class="form-control" id="email1" placeholder="Email address" name="email1">
              </div>
