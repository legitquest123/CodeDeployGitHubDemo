<!-- Required meta tags -->
  ...
  <link rel="stylesheet" href="{{asset('public/css/vendor/swiper.min.css')}}">
  <link rel="stylesheet" href="{{asset('public/css/vendor/jquery.tree-multiselect.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('public/css/searchbar.css')}}">
  <link rel="stylesheet" href="{{asset('public/css/index-v2.css')}}">
  <title>legitquest | Home page</title>
