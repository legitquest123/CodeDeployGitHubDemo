  <header class="header shadow">
    ...
    <nav class="navbar navbar-expand-lg  bg-white position-static navbar-sm ">
      <div class="container-fluid position-relative px-4 py-1">
        ...
        <a class="navbar-brand mr-4" href="http://localhost:8080/lqsite/">
          ...
          <ul class="navbar-nav">
            <li class="nav-item nav--has-sub-menu" data-toggle="hover">
              ...
              <ul class="nav-sub-menu dropdown-menu rounded-lg shadow dropdown-menu-right">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">My Bookmarks</a>
                </li>
                <li class="nav-item">
          ...
          <div class="offcanvas-collapse-inner">
            ...
            <ul class="navbar-nav ml-auto align-items-lg-center">
              <li class="nav-item">
                ...
                <a href="{{URL('price')}}" class="btn btn-primary btn-sm btn--has-shadow mt-3 mt-lg-0">Sign Up</a>
              </li>
            </ul>
          </div>
        </div>
