...
@section('title','LegitQuest | Research Request')
@section('content')
<main class="main">
	 @if(session('success'))
      ...
      <div class="container">
        ...
        <div class="row row-grid justify-content-center">
          ...
          <div class="col-md-8 align-self-center text-center mt-6 mb-5">
            ...
            <h1 class="mb-3 font-weight-bold">{{$data->heading}}</h1>
    ...
    <section class="section section-contact gradient-light--lean-left pt-1">
      <div class="container">
        <div class="contact__wrapper shadow-lg mt-n9 request-form-wrappper">

          <div class="row no-gutters">
            <div class="col-lg-5 contact-info__wrapper gradient-brand-color p-4 order-lg-2">
              <h3 class="text-white font-weight-bold mb-4">Legitquest launches “Legal Research Services on Demand”</h3>
              <p>Leqitquest announces the launch of its new Legal Research Service on Demand. We search from a database of Case Laws, Acts, Notifications, Ordinance, Bills e.t.c. as per your requirement. To get a price quote kindly email info@legitquest.com</p>
              <p>Fill the form and drop in any issue/facts/proposition pertaining to your query and we will provide you with a detailed in depth analysis and case treatment of being overruled, distinguished, approved e.t.c.</p>
              <p>Our team of expert legal researchers, strong database, varied tools and the AI technology delivers top notch simplified legal research.</p>

              <p>For any query/clarification contact us info@legitquest.com</p>

              <figure class="figure position-absolute m-0 opacity-06" style="bottom:0; right: 10px">
            ...
            <div class="col-lg-7 contact-form__wrapper p-4 order-lg-1">
              <form class="contact-form form-validate" name="researchrequest" method="POST" action="{{route('researchrequest')}}">
            @csrf
        ...
        <div class="row">
            <div class="col-sm-6 mb-3">
                ...
                <input class="form-control" name="mobile" id="mobile" type="text" placeholder="Phone number">
            </div>
            <div class="col-sm-6 mb-3">
        ...
        <div class="row">
            <div class="col-sm-6 mb-3">
                <label>Act</label>
                <input class="form-control"  type="text" name="act" id="act" placeholder="Transfer of Property Act,1882">
            </div>
            <div class="col-sm-6 mb-3">
                <label>Section</label>
                <input class="form-control"  name="section" id="section" type="text" placeholder="e.g.-10">
            </div>
        </div>

        <div class="row">
             <div class="col-sm-12 mb-3">
                <label>Brief Facts/Issue/Proposition (mandatory)*</label>
                <textarea class="form-control" rol="5" cols="30"  name="brief" id="brief" placeholder="need case laws for quashing of FIR; Privacy Rights and Data Protection"></textarea>
            </div>
        </div>
        ...
        <div class="row">
             <div class="col-sm-12 mb-3">
                ...
                <textarea name="jurisdiction" id="jurisdiction" class="form-control" rol="5" cols="30"  placeholder="Judgments of High Court/Supreme Court/Tribunal"></textarea>
            </div>
        </div>

        <div class="row">
          <div class="col-sm-12 mb-3 text-center">
            <input class="btn btn-primary btn-submit" class="button" type="submit">
          </div>
        </div>
    </form>
